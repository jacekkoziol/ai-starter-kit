...
predictably on any project — vendored into your repo as a single [`ai-kit/`](ai-kit/) folder.

## What is this?

This repository is the **home of the kit**. The [`ai-kit/`](ai-kit/) folder is the product: you copy it into
your own repo, point your agent at it, and it defines *how* the agent approaches work — not *what*
your project is. Everything outside `ai-kit/` here exists to build and maintain that folder.
...
| Path | What it is |
| --- | --- |
| [`ai-kit/`](ai-kit/) | **The kit** — the only thing vendored downstream. Portable manual, per-project profile, reference docs, skills, and templates. |
| [`ai-kit/README.md`](ai-kit/README.md) | Human guide to *using* the kit on a project (the full setup). |
...
1. Copy the [`ai-kit/`](ai-kit/) folder into your repo's root.
...
Those are the headlines — **follow [`ai-kit/README.md`](ai-kit/README.md) for the exact, current steps.**

## Where to go next

| I want to… | Read |
| --- | --- |
| Adopt / use the kit on a project | [`ai-kit/README.md`](ai-kit/README.md) |
| Understand the agent's operating rules | [`ai-kit/AGENT-INSTRUCTIONS.md`](ai-kit/AGENT-INSTRUCTIONS.md) |
